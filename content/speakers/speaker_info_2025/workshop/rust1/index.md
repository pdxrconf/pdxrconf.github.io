---
title: "Intro to Rust for R Developers Workshop"
url: "2025/workshop/rust1"
---
...
- Data types such as floats, integers, and booleans. 
  - See [Advanced R Chapter 3](https://adv-r.hadley.nz/vectors-chap.html)
- Iteration such as for / while loops, `purrr::map()` style iterators, and the `apply()` family of functions
  - See [Hands-On Programming with R](https://rstudio-education.github.io/hopr/loops.html), [R for Data Science Chapter 26](https://r4ds.hadley.nz/iteration.html)
- Control Flow
  - See [Advanced R Chapter 4](https://adv-r.hadley.nz/control-flow.html)
- Writing functions
  - See [R for Data Science Chapter 25](https://r4ds.hadley.nz/functions.html), [Advanced R Chapter 6](https://adv-r.hadley.nz/functions.html)
...
Learn more at <a href="https://josiahparry.com/">josiahparry.com</a>.
