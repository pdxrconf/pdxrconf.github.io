...
<div class="row" style="margin-top: 50px">
  ...
  <img src="/img/sponsors/ohsu2.png" class="img-responsive" alt="Oregon Health and Science University Logo"></a>
                        ...
                        <!-- Rstudio/posit and R and UW med-->
                        <div class="column">
                                <div class="col-md-3">
                                  <div class="row">
                                    <div class="image" style="padding: 20px">
                                  ...
                                  <div class="row">
                                    <div class="image" style="padding: 20px">
                                        <a href="https://posit.co/" target="_blank">
                                            <img src="/img/sponsors/Posit_logo.png" class="img-responsive" alt="posit Logo"></a>
                                            </div></div>
                                            <br>
                                    <div class="row">
                                    <div class="image" style="padding: 20px">
                        ...
                        <!-- Fred Hutch, PSU, eScience, U of Oregon-->
                        <div class="column">
                                <div class="col-md-3">
                                    <div class="row">
                                    <div class="image" style="padding: 20px">
                                        <a href="https://www.pdx.edu/" target="_blank">
  <img src="/img/sponsors/psu_business.png" class="img-responsive" alt="Portland State University Logo"></a>
                                    </div></div>
                                    <br>
                                    <div class="row">
                                    <div class="image" style="padding: 20px">
